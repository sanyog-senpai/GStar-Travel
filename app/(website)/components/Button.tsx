...
const variantStyles: Record<ButtonVariant, string> = {
  primary:
    "bg-white text-[#1d1e19] text-xs sm:text-sm px-4 py-2 sm:px-5 sm:py-2.5 " +
    "shadow-sm shadow-black/20 hover:bg-white/90 hover:scale-[1.02]",
  secondary:
    "bg-[#285340] text-white text-xs sm:text-sm px-4 py-2 sm:px-5 sm:py-2.5 " +
    "shadow-sm shadow-black/20 hover:bg-[#285340]/90 hover:scale-[1.02]",
  ghost:
    "bg-white/10 text-white/90 text-xs sm:text-sm border border-white/10 backdrop-blur-md " +
    "px-3 py-1.5 sm:px-4 sm:py-2 hover:bg-white/20 hover:border-white/20 hover:scale-[1.02]",
  text:
    "text-white/80 text-sm px-2 py-1 hover:text-white",
}
